...
const translations = {
  hebrew: {
    ...
    buttons: {
      ...
      readMore: "קרא עוד ←",
      startLesson: "התחל עכשיו",
      download: "הורד עכשיו",
      viewLinks: "צפה בקישורים",
      discoverApps: "גלה אפליקציות",
      browseBooks: "עיין בספרים",
      sendMessage: "שלח הודעה",
      shareAchievement: "שתף את ההישג שלך",
      sendNewMessage: "שלח הודעה חדשה"
    },
    hero: {
      welcome: "המסע שלך",
    ...
    painSection: {
      title: "אנחנו רואים את הכאב שלך",
      subtitle: "אנחנו מבינים את האתגרים שלך כי עברנו אותם בעצמנו. הנה מה שמצאנו:",
      challenges: {
        unbalancedNutrition: {
          percentage: "87%",
    ...
    features: {
      ...
      tracking: {
        title: "מעקב התקדמות",
        description: "מעקב אחר ההתקדמות והשגת המטרות שלך"
      }
    },
    athletesSection: {
      ...
      callToAction: {
        title: "מוכן לקחת את הביצועים שלך לשלב הבא?",
        subtitle: "הצטרף לספורטאים מקצועיים שכבר משתמשים במערכת שלנו",
        button: "התחל תוכנית ספורטאי",
    ...
    professionalPlatform: {
      ...
      challenges: {
        title: "אנחנו מבינים את האתגרים שלך",
        oldReality: {
          title: "המציאות הישנה",
          points: [
      ...
      benefits: {
        ...
        improvesResults: {
          title: "משפר תוצאות",
          description: "מעקב מדויק ותוצאות מוכחות עם הלקוחות שלך"
        },
        expandsAudience: {
          title: "מרחיב קהל",
        ...
        focusesOnGoals: {
          title: "מתמקד במטרות",
          description: "התמקדות במה שבאמת חשוב - הלקוחות שלך"
        }
      },
      platform: {
      ...
      callToAction: {
        question: "מוכן לשנות",
        highlightedQuestion: "את הפרקטיקה שלך?",
        buttons: {
          requestDemo: "בקש הדגמה",
          contactUs: "צור קשר"
        }
      },
      footer: "הצטרף למאות מקצוענים שכבר שינו את אופן העבודה שלהם עם BetterChoice"
    },
    testimonials: {
    ...
    blog: {
      ...
      posts: [
        ...
        },
        {
          ...
          description: "תרגילים פשוטים שתוכלו לבצע בבית ללא ציוד מיוחד...",
    ...
    actionPlan: {
      ...
      subtitle: "הגדר מטרות ספציפיות, תכנן תוכניות ועקוב אחר ההתקדמות שלך",
      weekly: {
        title: "מטרות שבועיות",
        goals: [
          "אימון 3 פעמים בשבוע",
    ...
    messages: {
      title: "הודעות פרטיות",
      subtitle: "תקשר באופן פרטי עם המדריכים והמומחים שלנו",
      guides: {
        title: "המדריכים שלך",
        ronit: {
      ...
      recentMessages: {
        ...
        ronit: {
          name: 'ד"ר רונית דיאטנית',
          time: "לפני שעה",
          message: "התוכנית התזונתית שלך נראית מצוינת! איך אתה מרגיש עם השינויים?"
        },
        alon: {
          name: "אלון מאמן כושר",
          time: "לפני 3 שעות",
          message: "זכור לנוח בין האימונים - זה חלק חשוב מהתהליך!"
        }
      }
    },
    celebrations: {
      title: "חגיגות והישגים",
      subtitle: "שתף וחגוג אירועים והישגים עם הקהילה שלנו",
      sarah: {
        name: "שרה כהן",
        time: "לפני שעה",
    ...
    resources: {
      title: "משאבים וכלים",
      subtitle: "גש למגוון רחב של דפי עבודה, קישורים שימושיים וחומרים נוספים",
      worksheets: {
        title: "דפי עבודה",
    ...
    contact: {
      title: "צור קשר",
      subtitle: "נשמח לעזור לך להתחיל את המסע שלך לבריאות טובה יותר",
      form: {
    ...
    profile: {
      ...
      myPlanTab: {
        ...
        subtitle: "התוכנית המותאמת אישית שלך",
        loading: "טוען תוכנית...",
        noPlan: "אין תוכנית זמינה",
        noPlanDescription: "התוכנית התזונתית שלך תוצג כאן לאחר שתסיים את ההרשמה",
      ...
      dailyLogTab: {
        ...
        subtitle: "עקוב אחר מה שאתה אוכל",
        today: "היום",
        addFood: "הוסף מזון",
      ...
      messagesTab: {
        ...
        startConversation: "התחל שיחה עם הבוט שלנו!",
